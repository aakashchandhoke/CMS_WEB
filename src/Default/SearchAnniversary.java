 ...
 * @author Aakash
 */
public class SearchAnniversary extends javax.swing.JFrame {

    /**
     * Creates new form SearchAnniversary
     */
    public SearchAnniversary() 
    {
            super("Search Anniversary Details");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        l1.setText("Anniversary Details Form");
...
try
{
    ...
    TableExampleAniv te=new TableExampleAniv(name);
    te.setVisible(true);
}
catch(Exception ee){}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchAnniversary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchAnniversary().setVisible(true);
            }
        });
    }
