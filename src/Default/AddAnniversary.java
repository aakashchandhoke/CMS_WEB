 ...
 * @author Aakash
 */
public class AddAnniversary extends javax.swing.JFrame {

    /**
     * Creates new form AddAnniversary
     */
    public AddAnniversary() {
        super("Anniversary Entry Form");
        initComponents();
    }
...
c1.addActionListener(new java.awt.event.ActionListener() {
    ...
    layout.setHorizontalGroup(
        ...
        .addGroup(layout.createSequentialGroup()
            .addGap(94, 94, 94)
            .addComponent(l8, javax.swing.GroupLayout.PREFERRED_SIZE, 415, javax.swing.GroupLayout.PREFERRED_SIZE)
...
try
{
    ...
    if(i==1)
    {
        ...
        yy=t3.getText();
        x=ob.addAniv(id,name,dd,mm,yy);
        if(x==1)
        {
            l8.setText("Anniversary details added");
            l8.setVisible(true);
        }
        else
        {
            l8.setText("Anniversary details not added");
            l8.setVisible(true);
        }
    }
    else
...
catch(Exception ee)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAnniversary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddAnniversary().setVisible(true);
            }
        });
    }
