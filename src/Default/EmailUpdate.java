...
public class EmailUpdate extends javax.swing.JFrame {
     ...
     */
    public EmailUpdate() {
        super("E-Mail Update/Delete Form");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        l1.setText("E-Mail Updation/Deletion Form");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(27, 27, 27)
                        .addComponent(l5, javax.swing.GroupLayout.PREFERRED_SIZE, 369, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(83, 83, 83)
                        .addComponent(l1)))
...
try
{
    ...
    int i=ob.validateIdEmail(id);
    email=t3.getText();
    name=t2.getText();
    check=ob1.checkVar(id, name,email);
    if(i==0&&check)//id exists.. then update..
    {
        int x=ob1.updateEmail(id,name,email);
        if(x==1)
        {
            l5.setText("Updated");
        }
...
catch(Exception ee)
{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EmailUpdate dialog = new EmailUpdate();
