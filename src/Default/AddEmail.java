...
public class AddEmail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(55, 55, 55)
                .addComponent(l5, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
try
{
    ...
    if(i==1)
    {
        email=t3.getText();
        name=t2.getText();
        x=ob.addEmail(id,name,email);
        if(x==1)
        {
            l5.setText("Email details added");
            l5.setVisible(true);
        }
        else
        {
            l5.setText("Email details not added");
            l5.setVisible(true);
        }
    }
    else
