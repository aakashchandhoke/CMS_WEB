 ...
 * @author Aakash
 */
public class SearchReminder extends javax.swing.JFrame {

    /**
     * Creates new form SearchReminder
     */
    ...
    private void initComponents() {
        ...
        l1.setText("Reminder Details Form");
...
try
{
    ...
    TableExampleRem te=new TableExampleRem(name);
    te.setVisible(true);
}
catch(Exception ee){}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchReminder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchReminder().setVisible(true);
            }
        });
    }
